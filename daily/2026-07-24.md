# Friday, 24 July 2026 - Day 066 - Phase 2 - Speed and Mocks
...
### 1. Quant - 75 min
- [ ] TIMED: Average: book Ch 4 + 25 problems. (strict timer).

### 2. Reasoning - 75 min
- [ ] TIMED: Blood relations: 20 questions. (strict timer).
...
---
*Previous day:* `2026-07-23.md` - *Next day:* `2026-07-25.md`