# Wednesday, 15 July 2026 - Day 057 - Phase 2 - Speed and Mocks
...
### 1. Quant - 75 min
- [ ] TIMED: Mixed arithmetic drill: 30 problems (45 min) - no new theory. (strict timer).

### 2. Reasoning - 75 min
- [ ] TIMED: Input-output OR Data sufficiency: 15 questions. (strict timer).
...
---
*Previous day:* `2026-07-14.md` - *Next day:* `2026-07-16.md`