# Wednesday, 01 July 2026 - Day 043 - Phase 2 - Speed and Mocks
...
### 1. Quant - 75 min
- [ ] TIMED: Percentage applications: 20 problems (profit-style word problems). (strict timer).

### 2. Reasoning - 75 min
- [ ] TIMED: Coding-decoding (basic): 20 questions. (strict timer).
...
---
*Previous day:* `2026-06-30.md` - *Next day:* `2026-07-02.md`